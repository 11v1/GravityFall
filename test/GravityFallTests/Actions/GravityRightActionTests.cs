...
namespace Aura.GravityFall.Actions.Tests
{
    ...
    public class GravityRightActionTests
    {
        ...
        public void ApplyActionTest()
        {
            ...
            result.First(p => p.HoleNumber == 19 && p.BallNumber == 1);
            result.First(p => p.HoleNumber == 19 && p.BallNumber == 18);
            result.First(p => p.HoleNumber == 26 && p.BallNumber == 2);
            result.First(p => p.HoleNumber == 26 && p.BallNumber == 19);
            result.First(p => p.HoleNumber == 26 && p.BallNumber == 27);
            result.First(p => p.HoleNumber == 27 && p.BallNumber == 3);
            result.First(p => p.HoleNumber == 27 && p.BallNumber == 20);
            result.First(p => p.HoleNumber == 3 && p.BallNumber == 11);
            result.First(p => p.HoleNumber == 3 && p.BallNumber == 26);
            result.First(p => p.HoleNumber == 4 && p.BallNumber == 12);
            result.First(p => p.HoleNumber == 5 && p.BallNumber == 13);
            result.First(p => p.HoleNumber == 6 && p.BallNumber == 14);
            result.First(p => p.HoleNumber == 7 && p.BallNumber == 15);
            result.First(p => p.HoleNumber == 8 && p.BallNumber == 16);
            result.First(p => p.HoleNumber == 9 && p.BallNumber == 17);
        }
    }
}